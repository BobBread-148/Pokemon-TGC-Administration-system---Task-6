...
# Clear screen: handles clear screen for the system.
def clear_screen():
    if os.name == 'nt':
        os.system('cls')
    else:
...
# Pause screen: handles pause screen for the system.
def pause_screen():
    input("\nPress Enter to continue...")


# Print as table: handles print as table for the system.
...
# Login: handles login for the system.
def login():
...
# Main menu: handles main menu for the system.
def main_menu():
    clear_screen()
...
# Log out: handles log out for the system.
def log_out():
    conn.commit()
    conn.close()
...
# Manage players: handles manage players for the system.
def manage_players():
...
# View account details: handles view account details for the system.
...
# Edit account details: handles edit account details for the system.
...
# Edit account details checks: handles edit account details checks for the system.
...
# View player stats: handles view player stats for the system.
...
# Player stats: handles player stats for the system.
...
# Add new player: handles add new player for the system.
def add_new_player():
    clear_screen()
    print("-" * 60)
...
# Delete player: handles delete player for the system.
def delete_player():
...
# Manage tournaments: handles manage tournaments for the system.
...
# View tournament details: handles view tournament details for the system.
...
# Edit tournament details: handles edit tournament details for the system.
...
# Edit tournament details checks: handles edit tournament details checks for the system.
def edit_tournament_details_checks(tournament, cursor, conn): 
    ...
    # 1. Update Tournament Name (Fixed: Added missing while loop header)
    while True:
    ...
    # 3. Update Venue ID (Fixed: Updated column names to match your ERD diagram)
    print("\n--- Available Venues ---")
...
# Register remove players: handles register remove players for the system.
...
# Create new tournament: handles create new tournament for the system.
def create_new_tournament():
    while True:
        ...
        # 3. Venue ID Selection & Verification (Fixed Indentation)
        print("\n--- Available Venues ---")
        cursor.execute("SELECT VenueID, VenueName, VenueCity, VenueCountry FROM Venue")
        venues = cursor.fetchall()
        for v in venues:
...
# Cancel tournament: handles cancel tournament for the system.
...
# Manage matches: handles manage matches for the system.
def manage_matches():
    if user_position in ["Administrator", "Moderator"]:
        clear_screen()
        print("-" * 75)
...
# View match details: handles view match details for the system.
...
# Manage staff: handles the staff management menu.
def manage_staff():
    if user_position == "Administrator":
        clear_screen()
        print("-" * 75)
...
def generate_analytical_reports():
    while True:
        ...
        # ----------------------------------------------------
        # 1. Players with largest collections
        # ----------------------------------------------------
        elif choice == "1":
            clear_screen()
            print("-" * 90)
...
# Main: handles main for the system.
def main():
    if login():
        while True:
