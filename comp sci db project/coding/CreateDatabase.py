...
def create_tables():
    try:
        ...
        CREATE TABLE CreatureCard(
            ...
            ElementType TEXT NOT NULL CHECK (ElementType IN ('Grass', 'Fire', 'Water', 'Lightning', 'Psychic', 'Fighting', 'Darkness', 'Metal', 'Dragon', 'Colorless')),
        ...
        CREATE TABLE EnergyCard(
            ...
            ElementType TEXT CHECK (
                (EnergyType = 'Basic' AND ElementType IN ('Grass', 'Fire', 'Water', 'Lightning', 'Psychic', 'Fighting', 'Darkness', 'Metal')) OR
                (EnergyType = 'Special' AND ElementType IS NULL)),
            SpecialEffects TEXT,
            FOREIGN KEY (CardID) REFERENCES Card(CardID)
        );""")
